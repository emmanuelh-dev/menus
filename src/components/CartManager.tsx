...
export default function CartManager({
  ...
  const [availableColonies, setAvailableColonies] = useState<Array<{ id: number, colony: string, zoneName: string, price: number }>>([]);
  ...
  const loadCustomer = async () => {
    // El checkout conserva este dato en el dispositivo; Go guarda el cliente
    // junto con el pedido y no se consulta la copia retirada de Supabase.
  ...
  const loadAvailableColonies = async () => {
    try {
      ...
      const coloniesMap: Array<{ id: number, colony: string, zoneName: string, price: number }> = [];
    ...
    <div className="cart-manager-container">
      ...
      {showSuccess && (
        <div className="fixed bottom-20 right-6 z-50 animate-in slide-in-from-right fade-in duration-300">
          <div className="bg-[var(--m-accent)] text-[var(--m-on-accent)] px-5 py-3 rounded-2xl shadow-2xl shadow-black/10 flex items-center gap-3 font-bold text-sm">
      ...
      <div className="fixed bottom-6 right-6 z-40">
        ...
        <button
          ...
          className={`relative bg-[var(--m-accent)] text-[var(--m-on-accent)] p-3 rounded-full transition-all hover:scale-105 hover:opacity-90 ${totalItems > 0 ? 'animate-pulse' : ''}`}
        >
          <ShoppingCart className="w-5 h-5" />
          {totalItems > 0 && (
            <span className="absolute -top-1 -right-1 bg-[var(--m-surface)] text-[var(--m-accent)] text-xs font-bold rounded-full w-4 h-4 flex items-center justify-center text-[10px]">
              {totalItems}
            </span>
          )}
        </button>
                        ...
                        <div className="flex items-center gap-2">
                          {itemData && (
                            <button
                              ...
                              className="px-3 py-1.5 bg-[var(--m-accent)] text-[var(--m-on-accent)] rounded-lg hover:opacity-90 text-sm font-semibold flex items-center gap-1.5"
                            >
        ...
        >
          <div className="bg-white rounded-2xl w-full sm:max-w-md max-h-[90dvh] flex flex-col shadow-2xl">
            <div className="p-4 border-b border-neutral-100 flex items-center justify-between bg-white sticky top-0 z-10 rounded-t-2xl">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[var(--m-bg)] rounded-xl flex items-center justify-center text-[var(--m-accent)]">
                  <ShoppingCart className="w-5 h-5" />
                </div>
                <div>
            ...
            <div className="flex bg-neutral-50 border-b border-neutral-100 p-1 m-4 rounded-xl">
              <button
                ...
                className={`flex-1 py-2.5 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${activeTab === 'cart' ? 'bg-[var(--m-surface)] text-[var(--m-accent)] shadow-sm' : 'text-[var(--m-muted)] hover:text-[var(--m-text)]'}`}
              >
              ...
              <button
                ...
                className={`flex-1 py-2.5 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${activeTab === 'checkout' ? 'bg-[var(--m-surface)] text-[var(--m-accent)] shadow-sm' : 'text-[var(--m-muted)] hover:text-[var(--m-text)]'}`}
              >
                <Truck size={14} />
                        ...
                        <div key={item.id} className="space-y-3">
                          <div className="flex gap-4 items-start">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs font-bold text-[var(--m-accent)] mt-1">{money(item.price)}</p>
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-4 py-3 text-sm bg-neutral-50 border border-transparent rounded-xl focus:bg-white focus:border-[var(--m-accent)] transition-all outline-none"
                          />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-3 rounded-2xl border-2 transition-all group ${paymentMethod === 'cash' ? 'border-[var(--m-accent)] bg-[var(--m-bg)] text-[var(--m-accent)]' : 'border-neutral-50 bg-neutral-50 text-neutral-400 hover:border-neutral-200'}`}
                      >
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 transition-all ${paymentMethod === 'cash' ? 'bg-[var(--m-accent)] text-[var(--m-on-accent)]' : 'bg-white text-neutral-400'}`}>
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-3 rounded-2xl border-2 transition-all group ${paymentMethod === 'card' ? 'border-[var(--m-accent)] bg-[var(--m-bg)] text-[var(--m-accent)]' : 'border-neutral-50 bg-neutral-50 text-neutral-400 hover:border-neutral-200'}`}
                      >
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 transition-all ${paymentMethod === 'card' ? 'bg-[var(--m-accent)] text-[var(--m-on-accent)]' : 'bg-white text-neutral-400'}`}>
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-3 rounded-2xl border-2 transition-all group ${paymentMethod === 'transfer' ? 'border-[var(--m-accent)] bg-[var(--m-bg)] text-[var(--m-accent)]' : 'border-neutral-50 bg-neutral-50 text-neutral-400 hover:border-neutral-200'}`}
                      >
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 transition-all ${paymentMethod === 'transfer' ? 'bg-[var(--m-accent)] text-[var(--m-on-accent)]' : 'bg-white text-neutral-400'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`flex flex-col items-center justify-center p-3.5 rounded-2xl border-2 transition-all group ${wantsDelivery ? 'border-[var(--m-accent)] bg-[var(--m-bg)] text-[var(--m-accent)]' : 'border-neutral-50 bg-neutral-50 text-neutral-400 hover:border-neutral-200'}`}
                      >
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 transition-all ${wantsDelivery ? 'bg-[var(--m-accent)] text-[var(--m-on-accent)]' : 'bg-white text-neutral-400'}`}>
                          ...
                          <>
                            <div className="space-y-1.5">
                              ...
                              <select
                                ...
                                className="w-full px-4 py-3 text-sm bg-neutral-50 border border-transparent rounded-xl focus:bg-white focus:border-[var(--m-accent)] transition-all outline-none appearance-none"
                              >
                            ...
                            <div className="space-y-1.5">
                              ...
                              <GooglePlacesAutocomplete
                                ...
                                className="w-full px-4 py-3 text-sm bg-neutral-50 border border-transparent rounded-xl focus:bg-white focus:border-[var(--m-accent)] transition-all outline-none"
                              />
                            </div>
                          </>
                        ) : (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-[2] py-3.5 bg-[var(--m-accent)] hover:opacity-90 disabled:bg-neutral-200 text-[var(--m-on-accent)] rounded-xl font-bold transition-all flex items-center justify-center gap-2"
                    >
                      Siguiente
                ...
                <div className="space-y-4">
                  <div className="space-y-2 mb-2">
                    ...
                    {wantsDelivery && shippingZone && (
                      <div className="flex justify-between text-xs font-bold text-[var(--m-accent)] uppercase tracking-widest">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-neutral-50">
                      ...
                      <span className="text-2xl font-black text-[var(--m-accent)]">{money(totalPrice + (wantsDelivery && shippingZone ? shippingZone.price : 0))}</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 text-sm bg-neutral-50 border border-transparent rounded-xl focus:bg-white focus:border-[var(--m-accent)] transition-all outline-none resize-none h-20"
                    />
                  </div>
                  <button
                    onClick={sendToWhatsApp}
                    disabled={creatingOrder || (wantsDelivery && !shippingZone) || !customerName || !customerPhone || cart.length === 0}
                    className="w-full py-4 bg-[var(--m-accent)] hover:opacity-90 disabled:bg-neutral-200 text-[var(--m-on-accent)] rounded-2xl font-black text-lg shadow-xl shadow-black/10 flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:scale-100"
                  >
                    {creatingOrder ? (
          ...
          <div className="bg-white w-full sm:max-w-md max-h-[85dvh] flex flex-col rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
              <div className="p-6 sm:p-8 pb-4 shrink-0">
                ...
                <p className="text-2xl font-black text-[var(--m-accent)] mt-4">{money(configuringItem.price)}</p>
              </div>
                        ...
                        <div className="flex justify-between items-end px-1 mb-4">
                          ...
                          {detectLimit(configuringItem) && (
                            <div className={`text-right px-3 py-1.5 rounded-xl border-2 transition-all ${Object.values(tempCounts).reduce((a, b) => a + (b as number), 0) === detectLimit(configuringItem)
                              ? 'bg-[var(--m-accent)] border-[var(--m-accent)] text-[var(--m-on-accent)]'
                            ...
                            return (
                              <div key={val} className="flex items-center justify-between bg-neutral-50 p-3 rounded-2xl border border-neutral-100/50 hover:bg-white hover:shadow-sm transition-all text-neutral-700">
                                <div className="flex flex-col">
                                  ...
                                  {opt.prices?.[val] && (
                                    <span className="text-[10px] font-black text-[var(--m-accent)]">+$ {opt.prices[val]}</span>
                                  )}
                                </div>
                                <div className="flex items-center gap-4">
                                  ...
                                  <button
                                    ...
                                    className="w-8 h-8 rounded-lg bg-white shadow-sm flex items-center justify-center font-bold text-neutral-400 hover:text-[var(--m-accent)] transition-colors border border-neutral-100"
                                  >
                                    +
                                  </button>
                                </div>
