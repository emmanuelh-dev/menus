  ...
  return (
    <div className="w-full space-y-1.5">
      ...
      <div className="relative">
        <select
          className={`w-full bg-white border border-neutral-200 px-3 py-2 rounded-lg text-sm outline-none appearance-none focus:ring-2 focus:ring-neutral-900/5 focus:border-neutral-900 transition-all cursor-pointer ${error ? "border-red-500" : ""
            } ${className}`}
          {...props}
        >
          {options.map((opt) => (
