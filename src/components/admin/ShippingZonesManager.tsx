  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        leftContent={
          <div>
            <h1 className="text-xl font-black uppercase tracking-tight text-gray-900">Zonas de Envío</h1>
            <p className="text-xs text-gray-500 font-medium">Configura las áreas de entrega y sus costos.</p>
          </div>
        }
      />
