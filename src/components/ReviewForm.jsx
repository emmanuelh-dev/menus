...
export default function ReviewForm({ restaurantName, id, initialReviews = [], isAdmin = false }) {
  ...
  return (
    <div className="space-y-12 max-w-4xl mx-auto pb-20">
      ...
      <form onSubmit={handleSubmit} className="bg-white/5 p-8 rounded-[2.5rem] border border-white/10 backdrop-blur-sm shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <input 
            ...
            className="p-4 bg-white/5 rounded-2xl outline-none border border-white/10 focus:border-red-500/50 text-white placeholder:text-stone-500 transition-all" 
          />
          <input 
        ...
        <textarea 
          ...
          className="w-full p-6 bg-white/5 rounded-2xl h-40 mb-6 outline-none border border-white/10 focus:border-red-500/50 text-white placeholder:text-stone-500 resize-none transition-all" 
        />
      ...
      <div className="space-y-6">
        ...
        {reviews.map((rev) => (
          <div key={rev.id} className="bg-white/5 p-8 rounded-[2.5rem] border border-white/10 backdrop-blur-sm shadow-sm group hover:bg-white/[0.07] transition-all">
